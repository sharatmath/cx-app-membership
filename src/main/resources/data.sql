...
CREATE TABLE PREPAID_CX_OFFER_ELIGIBILITY (
  ...
  OFFER_CONFIG_ID VARCHAR2(50) NOT NULL,
  IS_FREQUENCY_ONLY NUMBER(1) NOT NULL,
  IS_FREQUENCY_AND_TIME NUMBER(1) NOT NULL,
  FREQUENCY NUMBER NOT NULL,
  NUMBER_OF_DAYS NUMBER NOT NULL,
  IS_OFFER_LEVEL_CAP_ONLY NUMBER(1) NOT NULL,
  IS_OFFER_LEVEL_CAP_AND_PERIOD NUMBER(1) NOT NULL,
  OFFER_LEVEL_CAP_VALUE NUMBER NOT NULL,
  OFFER_LEVEL_CAP_PERIOD_VALUE NUMBER NOT NULL
);
...
CREATE TABLE PREPAID_CX_OFFER_REDEMPTION (
  ...
  TOTAL_RECURRING_FREQUENCY VARCHAR2(50) DEFAULT NULL,
  ...
  RECURRING_FREQUENCY_PERIOD_VALUE VARCHAR2(50) DEFAULT NULL,
