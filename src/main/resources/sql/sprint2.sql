...
ALTER TABLE PREPAID_OFFER_MEMBERSHIP_EXCLUS
ADD  EVALUATION_TYPE VARCHAR2(50) ;
ALTER TABLE PREPAID_OFFER_MEMBERSHIP_EXCLUS
ADD  EVALUATION_STATUS VARCHAR2(1000) ;
ALTER TABLE PREPAID_OFFER_MEMBERSHIP_EXCLUS
DROP COLUMN  OFFER_SELECTION_ID;

ALTER TABLE PREPAID_OFFER_MEMBERSHIP_EXCLUS
ADD  INVOCATION_ID VARCHAR2(1000);
ALTER TABLE PREPAID_OFFER_MEMBERSHIP_EXCLUS
ADD  OFFER_ELIGIBILITY_TX_ID NUMBER;

ALTER TABLE PREPAID_OFFER_MEMBERSHIP
ADD  INVOCATION_ID VARCHAR2(1000);
ALTER TABLE PREPAID_OFFER_MEMBERSHIP
ADD  OFFER_ELIGIBILITY_TX_ID NUMBER;